...
interface TogglePackageProps {
  packageId: string;
  initialIsActive: boolean;
}

export default function TogglePackage({ packageId, initialIsActive }: TogglePackageProps) {
  ...
  async function toggle() {
    ...
    try {
      ...
      toast.success(isActive ? "Package suspended" : "Package activated");
    } catch {
