    ...
    <section className="bg-cream py-16 sm:py-24">
      <Container>
        <div className="max-w-4xl mx-auto">
          <Link href="/hackathons" className="text-sm font-semibold text-orangeDeep hover:underline mb-6 inline-block">
            ← All hackathons
          </Link>
          ...
          <div className="bg-white rounded-2xl shadow-[0_2px_8px_rgba(22,22,22,0.06),0_12px_32px_rgba(22,22,22,0.07)] p-6 sm:p-10 mb-8">
            ...
            <div className="flex flex-wrap gap-4 text-sm text-inkSoft mb-8">
              ...
              <span>Registered: <strong className="text-charcoal">{hackathon._count.registrations}</strong></span>
            </div>
          ...
          <div className="grid lg:grid-cols-[1fr_0.38fr] gap-8">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl p-6 sm:p-8">
                ...
                <div className="space-y-4">
                  {hackathon.timelines.map((t) => (
                    <div key={t.id} className="border-l-2 border-orange pl-4">
