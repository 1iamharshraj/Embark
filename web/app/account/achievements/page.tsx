        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex items-start justify-between mb-8">
            <div>
              ...
              <h1 className="font-display font-bold text-3xl text-charcoal mt-2">My hackathons</h1>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-charcoal/8 p-6 sm:p-8 mb-8">
