        ...
        <div className="max-w-5xl mx-auto">
          <div className="mb-8 flex items-center justify-between gap-4 flex-wrap">
            <div>
              ...
              <p className="text-inkSoft">Playbooks and mentorship sessions you have bought or started checking out.</p>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-[0_2px_8px_rgba(22,22,22,0.06),0_12px_32px_rgba(22,22,22,0.07)] overflow-hidden">
            {orders.length === 0 ? (
              <div className="p-8 sm:p-12 text-center">
                ...
                <Button href="/playbooks" size="sm">Browse playbooks</Button>
              </div>
            ) : (
