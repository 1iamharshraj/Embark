...
async function main() {
  ...
  // Sample mentors for discovery / booking request demos.
  const mentorData = [
    {
      slug: "kavitha-venkat",
      name: "Kavitha Venkat",
      image: "/mentors/kavitha.jpg",
      role: "FMCG Brand Director",
      company: "ITC Limited",
      college: "IIM Calcutta",
      batch: "2015",
      tier: "premium",
      phases: [2, 3],
      streams: ["Marketing", "FMCG"],
      rating: 4.9,
      sessions: 140,
      years: 8,
      price: 2999,
      guestLectures: true,
      expertise: ["Brand Management", "FMCG", "Rural Marketing"],
      bio: "FMCG brand leader helping students prepare for brand management and marketing interviews.",
      reviewText: "Kavitha gave me a clear roadmap for FMCG placements.",
      reviewWho: "MBA student, IIM Lucknow",
    },
    {
      slug: "rohan-sharma",
      name: "Rohan Sharma",
      ...
      tier: "premium",
      phases: [1, 2, 3],
      streams: ["Strategy", "Consulting"],
      rating: 4.9,
      sessions: 120,
      years: 6,
      price: 2999,
      guestLectures: true,
      expertise: ["Strategy", "Consulting", "Market Entry"],
      bio: "Former strategy consultant helping students crack case interviews and consulting roles.",
      reviewText: "Rohan simplified frameworks I struggled with for months.",
      reviewWho: "MBA student, IIM Indore",
    },
    {
      slug: "priya-nair",
      name: "Priya Nair",
      ...
      price: 2499,
      guestLectures: true,
      expertise: ["Brand Management", "FMCG", "Digital Marketing"],
      bio: "Marketing leader with experience across legacy and D2C brands.",
      reviewText: "Priya gave actionable feedback on my brand manager interview prep.",
      reviewWho: "MBA student, SPJIMR",
    },
    {
      slug: "arjun-verma",
      name: "Arjun Verma",
      image: "/mentors/arjun.jpg",
      ...
      tier: "standard",
      phases: [1, 2],
      streams: ["Product", "Tech"],
      rating: 4.7,
      sessions: 80,
      years: 4,
      price: 1999,
      guestLectures: false,
      expertise: ["Product Management", "PM Interviews", "Growth"],
      bio: "PM with a passion for helping non-tech MBAs transition into product.",
      reviewText: "Clear, structured guidance on product case questions.",
      reviewWho: "MBA student, IIM Kozhikode",
    },
    {
      slug: "meera-iyer",
      name: "Meera Iyer",
      ...
      tier: "premium",
      phases: [2, 3],
      streams: ["Finance", "Investment Banking"],
      rating: 4.9,
      sessions: 150,
      years: 7,
      price: 3499,
      guestLectures: true,
      expertise: ["Investment Banking", "Valuation", "Finance Careers"],
      bio: "Investment banker helping students navigate finance interviews and career paths.",
      reviewText: "Meera's valuation session was worth every rupee.",
      reviewWho: "MBA student, IIM Calcutta",
    },
    {
      slug: "vikram-patel",
      name: "Vikram Patel",
      ...
      price: 2299,
      guestLectures: false,
      expertise: ["Operations", "Supply Chain", "Lean Six Sigma"],
      bio: "Operations leader with experience in e-commerce and manufacturing.",
      reviewText: "Helped me structure operations cases with real Amazon examples.",
      reviewWho: "MBA student, IIFT",
    },
    {
      slug: "sneha-gupta",
      name: "Sneha Gupta",
      ...
      tier: "standard",
      phases: [2],
      streams: ["HR", "General Management"],
      rating: 4.7,
      sessions: 60,
      years: 5,
      price: 1799,
      guestLectures: true,
      expertise: ["HR", "Leadership", "Organizational Behaviour"],
      bio: "HR leader focused on helping students build people-centric careers.",
      reviewText: "Sneha gave me clarity on HR career paths after my MBA.",
      reviewWho: "MBA student, MDI Gurgaon",
    },
    {
      slug: "karan-malhotra",
      name: "Karan Malhotra",
      image: "/mentors/karan.jpg",
      role: "Entrepreneur",
      company: "D2C Startup",
      college: "IIM Lucknow",
      batch: "2017",
      tier: "standard",
      phases: [1, 2, 3],
      streams: ["Entrepreneurship", "Strategy"],
      rating: 4.8,
      sessions: 55,
      years: 4,
      price: 2199,
      guestLectures: true,
      expertise: ["Entrepreneurship", "Startups", "Go-to-Market"],
      bio: "Serial entrepreneur mentoring aspiring founders and product leaders.",
      reviewText: "Karan pushed me to think like a founder, not just a candidate.",
      reviewWho: "MBA student, IIM Trichy",
    },
    {
      slug: "ananya-sen",
      name: "Ananya Sen",
      ...
      tier: "premium",
      phases: [2, 3],
      streams: ["Finance", "Private Equity"],
      rating: 4.9,
      sessions: 110,
      years: 5,
      price: 3299,
      guestLectures: false,
      expertise: ["Private Equity", "LBO", "Financial Modeling"],
      bio: "Private equity professional demystifying buy-side recruiting.",
      reviewText: "Ananya's LBO modeling walkthrough was exceptional.",
      reviewWho: "MBA student, IIM Ahmedabad",
    },
    {
      slug: "rahul-kapoor",
      name: "Rahul Kapoor",
      ...
      price: 1899,
      guestLectures: true,
      expertise: ["Sales", "B2B SaaS", "Account Management"],
      bio: "Sales leader helping students explore non-consulting go-to-market roles.",
      reviewText: "Rahul's mock sales interview was intense and useful.",
      reviewWho: "MBA student, NMIMS",
    },
    {
      slug: "divya-raghavan",
      name: "Divya Raghavan",
      ...
      tier: "premium",
      phases: [1, 2, 3],
      streams: ["Strategy", "Operations"],
      rating: 4.8,
      sessions: 90,
      years: 7,
      price: 2799,
      guestLectures: true,
      expertise: ["Chief of Staff", "Strategy", "Operations"],
      bio: "Chief of Staff with cross-functional experience at high-growth startups.",
      reviewText: "Divya helped me map my MBA to a chief-of-staff path.",
      reviewWho: "MBA student, IIM Shillong",
    },
  ];
