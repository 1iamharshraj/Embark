  ...
  return (
    <>
      ...
      <section id="fit" className="bg-cream py-16 sm:py-20">
        <Container>
          <div className="max-w-3xl">
            <span className="text-xs font-semibold uppercase tracking-[0.14em] text-green mb-3 block">Is this you?</span>
      ...
      <section id="recruiters" className="bg-white py-16 sm:py-20">
        <Container>
          <div className="max-w-3xl mb-8">
            <span className="text-xs font-semibold uppercase tracking-[0.14em] text-green mb-3 block">Who hires</span>
            <h2 className="font-display font-bold text-3xl sm:text-4xl text-charcoal">
          ...
          <div className="flex flex-wrap gap-3">
            {c.recruiters.map((r) => (
              <span
                key={r}
                className="text-sm font-semibold bg-navy text-white rounded-full px-4 py-2"
              >
                {r}
              </span>
            ))}
      ...
      <section id="skills" className="bg-white py-16 sm:py-20">
        <Container>
          <div className="max-w-3xl mb-8">
            ...
            <p className="text-inkSoft text-sm">Your ticks save automatically on this device.</p>
          </div>
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-8">
              ...
              <div className="bg-white rounded-2xl p-6 min-w-[260px]">
                <div className="font-display font-extrabold text-3xl text-charcoal mb-1">
                  ₹{playbook.price}{" "}
                  <small className="font-body font-normal text-sm text-inkSoft">one-time</small>
                </div>
                ...
                {!bought ? (
                  ...
                  <div className="text-center py-2">
                    ...
                    <p className="text-xs text-inkSoft">Sign in from the top bar to access it.</p>
                  </div>
                )}
                <Link
                  href="/mentorship"
